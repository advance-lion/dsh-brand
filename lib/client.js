...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const KEYS = ['name', 'version', 'headline', 'badge', 'intro', 'logoText', 'logoUrl', 'title', 'favicon', 'sendIcon', 'stopIcon', 'hideNotice', 'thinkText', 'colorEnabled', 'colorTargets', 'color']
    ...
    function blank() {
      return { name: '', version: '', headline: '', badge: '', intro: '', logoText: '', logoUrl: '', title: '', favicon: '', sendIcon: '', stopIcon: '', hideNotice: '', thinkText: '', colorEnabled: 'true', colorTargets: ALL_COLOR_TARGETS, color: '' }
    }
        ...
        const write = (cfg, pending, done) => {
          ...
          fetch(API, {
            ...
            .then((saved) => {
              ...
              if (cfg.colorTargets !== undefined && normalized.colorTargets !== cfg.colorTargets) {
