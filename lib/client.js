...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const KEYS = ['name', 'version', 'headline', 'badge', 'intro', 'logoText', 'logoUrl', 'title']
      ...
      function BrandSection() {
        ...
        return h('div', { className: 'dsh-brand-form' },
          h('div', { className: 'dsh-brand-hint' },
            '一键替换界面品牌信息，配置保存在 $DSH_HOME/dsh-brand.json，可直接分发给二改部署。Hero 三项（主标题 / 徽标 / 简介）任一填写即接管新会话页头部；全部留空显示官方默认。'),
